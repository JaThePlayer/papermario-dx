...
/*
INCLUDE_IMG("ui/battle/status/defdown_0.png", ui_battle_status_pup_0_png);
INCLUDE_PAL("ui/battle/status/defdown_0.pal", ui_battle_status_pup_0_pal);
INCLUDE_IMG("ui/battle/status/defdown_1.png", ui_battle_status_pup_1_png);
INCLUDE_PAL("ui/battle/status/defdown_1.pal", ui_battle_status_pup_1_pal);
