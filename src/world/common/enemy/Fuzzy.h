...
#define FLOWER_FUZZY_ANIMS \
{ \
    .idle   = ANIM_Fuzzy_Flower_Walk, \
    ...
    .anim_9 = ANIM_Fuzzy_Flower_Run, \
    .anim_A = ANIM_Fuzzy_Flower_Run, \
    .anim_B = ANIM_Fuzzy_Flower_Run, \
    .anim_C = ANIM_Fuzzy_Flower_Run, \
    .anim_D = ANIM_Fuzzy_Flower_Run, \
    .anim_E = ANIM_Fuzzy_Flower_Run, \
    .anim_F = ANIM_Fuzzy_Flower_Run, \
}
