...
NpcGroupList N(NpcsBefore) = {
    ...
    NPC_GROUP(N(NpcData_Goomba_02), BTL_KMR_1_FORMATION_03, BTL_KMR_1_STAGE_03),
    NPC_GROUP(N(NpcData_SpikedGoomba), BTL_KMR_1_FORMATION_0A, BTL_KMR_3_STAGE_03),
    NPC_GROUP(N(NpcData_Paragoomba), BTL_KMR_1_FORMATION_08, BTL_KMR_3_STAGE_03),
    {}
};
