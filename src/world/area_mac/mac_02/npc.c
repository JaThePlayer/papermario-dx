...
NpcData N(NpcData_TayceT)[] = {
    ...
    },
    {
        ...
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_FLYING | ENEMY_FLAG_DO_NOT_KILL,
        .drops = NO_DROPS,
        .animations = TRIAL_BOO_ANIMS,
