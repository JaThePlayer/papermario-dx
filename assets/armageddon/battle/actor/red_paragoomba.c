...
s32 N(DefaultAnims)[] = {
    ...
    STATUS_KEY_STONE,     ANIM_Paragoomba_Red_Still,
    STATUS_KEY_SLEEP,     ANIM_Paragoomba_Red_Sleep,
    STATUS_KEY_POISON,    ANIM_Paragoomba_Red_Idle,
    STATUS_KEY_STOP,      ANIM_Paragoomba_Red_Still,
    STATUS_KEY_STATIC,    ANIM_Paragoomba_Red_Idle,
    STATUS_KEY_PARALYZE,  ANIM_Paragoomba_Red_Still,
    STATUS_KEY_DIZZY,     ANIM_Paragoomba_Red_Dizzy,
    STATUS_KEY_UNUSED,      ANIM_Paragoomba_Red_Dizzy,
    STATUS_END,
};

s32 N(ShuffleAnims)[] = {
    STATUS_KEY_NORMAL,    ANIM_Paragoomba_Red_Run,
    STATUS_KEY_STONE,     ANIM_Paragoomba_Red_Still,
    STATUS_KEY_SLEEP,     ANIM_Paragoomba_Red_Sleep,
    STATUS_KEY_POISON,    ANIM_Paragoomba_Red_Idle,
    STATUS_KEY_STOP,      ANIM_Paragoomba_Red_Still,
    STATUS_KEY_STATIC,    ANIM_Paragoomba_Red_Run,
    STATUS_KEY_PARALYZE,  ANIM_Paragoomba_Red_Still,
    STATUS_KEY_DIZZY,     ANIM_Paragoomba_Red_Dizzy,
    STATUS_KEY_UNUSED,      ANIM_Paragoomba_Red_Dizzy,
    STATUS_END,
...
EvtScript N(EVS_OnEnemyHit) = {
    Call(InflictCustomStatus, ACTOR_SELF, CHARGE_STATUS, 99, 1, 100)
    Return
    End
};
...
EvtScript N(EVS_Init) = {
    ...
    Call(BindOnEnemyDamaged, ACTOR_SELF, Ref(N(EVS_OnEnemyHit)))
    Return
    End
};
...
EvtScript N(EVS_Paragoomba_GoHome) = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_FLYING, ANIM_Paragoomba_Red_Idle)
    Return
    End
};
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(EVENT_HIT)
            ...
            SetConst(LVar1, ANIM_Paragoomba_Red_Hurt)
            ExecWait(EVS_Enemy_Hit)
        EndCaseGroup
        CaseEq(EVENT_BURN_HIT)
            SetConst(LVar0, PRT_FLYING)
            SetConst(LVar1, ANIM_Paragoomba_Red_BurnHurt)
            SetConst(LVar2, ANIM_Paragoomba_Red_BurnStill)
        ...
        CaseEq(EVENT_BURN_DEATH)
            ...
            ExecWait(EVS_Enemy_BurnHit)
            SetConst(LVar0, PRT_FLYING)
            SetConst(LVar1, ANIM_Paragoomba_Red_BurnStill)
        ...
        CaseEq(EVENT_SHOCK_HIT)
            SetConst(LVar0, PRT_FLYING)
            SetConst(LVar1, ANIM_Paragoomba_Red_Electrocute)
            ExecWait(EVS_Enemy_ShockHit)
            SetConst(LVar0, PRT_FLYING)
            SetConst(LVar1, ANIM_Paragoomba_Red_Hurt)
            ExecWait(EVS_Enemy_Knockback)
            Call(SetAnimation, ACTOR_SELF, PRT_FLYING, ANIM_Paragoomba_Red_Dizzy)
        ...
        CaseEq(EVENT_SHOCK_DEATH)
            ...
            ExecWait(EVS_Enemy_ShockHit)
            SetConst(LVar0, PRT_FLYING)
            SetConst(LVar1, ANIM_Paragoomba_Red_HurtStill)
            ExecWait(EVS_Enemy_Death)
            Return
        ...
        CaseOrEq(EVENT_AIR_LIFT_FAILED)
            SetConst(LVar0, PRT_FLYING)
            SetConst(LVar1, ANIM_Paragoomba_Red_Idle)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            ...
            SetConst(LVar0, PRT_FLYING)
            SetConst(LVar1, ANIM_Paragoomba_Red_Run)
            SetConst(LVar2, ANIM_Paragoomba_Red_Hurt)
...
EvtScript N(EVS_TakeTurn) = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Call(SetAnimation, ACTOR_SELF, PRT_FLYING, ANIM_Paragoomba_Red_Dive)
            Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            ...
            Thread
                ...
                EndLoop
            EndThread
            Call(SetAnimation, ACTOR_SELF, PRT_FLYING, ANIM_Paragoomba_Red_Miss)
