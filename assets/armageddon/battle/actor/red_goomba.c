...
s32 N(DefaultAnims)[] = {
    ...
    STATUS_KEY_STONE,     ANIM_Goomba_Red_Still,
    STATUS_KEY_SLEEP,     ANIM_Goomba_Red_Sleep,
    STATUS_KEY_POISON,    ANIM_Goomba_Red_Idle,
    STATUS_KEY_STOP,      ANIM_Goomba_Red_Still,
    STATUS_KEY_STATIC,    ANIM_Goomba_Red_Idle,
    STATUS_KEY_PARALYZE,  ANIM_Goomba_Red_Still,
    STATUS_KEY_DIZZY,     ANIM_Goomba_Red_Dizzy,
    STATUS_KEY_UNUSED,    ANIM_Goomba_Red_Dizzy,
    STATUS_END,
};

// while shuffling around during idle
s32 N(ShuffleAnims)[] = {
    STATUS_KEY_NORMAL,    ANIM_Goomba_Red_Run,
    STATUS_KEY_STONE,     ANIM_Goomba_Red_Still,
    STATUS_KEY_SLEEP,     ANIM_Goomba_Red_Sleep,
    STATUS_KEY_POISON,    ANIM_Goomba_Red_Idle,
    STATUS_KEY_STOP,      ANIM_Goomba_Red_Still,
    STATUS_KEY_STATIC,    ANIM_Goomba_Red_Run,
    STATUS_KEY_PARALYZE,  ANIM_Goomba_Red_Still,
    STATUS_KEY_DIZZY,     ANIM_Goomba_Red_Dizzy,
    STATUS_KEY_UNUSED,    ANIM_Goomba_Red_Dizzy,
    STATUS_END,
...
EvtScript N(EVS_Init) = {
    ExecWait(N(EVS_Init_FromParagoomba))
    Return
    End
};
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(EVENT_HIT)
            ...
            SetConst(LVar1, ANIM_Goomba_Red_Hurt)
            ExecWait(EVS_Enemy_Hit)
        EndCaseGroup
        CaseEq(EVENT_BURN_HIT)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goomba_Red_BurnHurt)
            SetConst(LVar2, ANIM_Goomba_Red_BurnStill)
        ...
        CaseEq(EVENT_BURN_DEATH)
            ...
            ExecWait(EVS_Enemy_BurnHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goomba_Red_BurnStill)
        ...
        CaseEq(EVENT_SPIN_SMASH_DEATH)
            ...
            ExecWait(EVS_Enemy_SpinSmashHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goomba_Red_Dead)
            ExecWait(EVS_Enemy_Death)
            Return
        CaseEq(EVENT_SHOCK_HIT)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goomba_Red_Electrocute)
            ...
            Wait(5)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goomba_Red_Idle)
        ...
        CaseOrEq(EVENT_AIR_LIFT_FAILED)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goomba_Red_Idle)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goomba_Red_Run)
            SetConst(LVar2, ANIM_Goomba_Red_Hurt)
...
EvtScript N(EVS_TakeTurn) = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goomba_Red_Midair)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goomba_Red_Sleep)
            ...
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goomba_Red_Hurt)
            Wait(5)
    ...
    Loop(2)
        ...
        EndThread
        Call(JumpToGoal, ACTOR_SELF, 16, false, true, false)
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goomba_Red_Tense)
        Call(SetActorScale, ACTOR_SELF, Float(1.1), Float(0.8), Float(1.0))
        Wait(1)
        Call(SetActorScale, ACTOR_SELF, Float(1.3), Float(0.5), Float(1.0))
        Wait(1)
